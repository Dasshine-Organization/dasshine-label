...
FORMATS_BY_CATEGORY: Dict[str, List[FormatMeta]] = {
    ...
    "embodied": [
        FormatMeta("json", "Embodied JSON", "json", "dasshine.embodied_sequence.v7"),
        FormatMeta("lerobot_dataset", "LeRobot Dataset", "zip", "parquet + videos ZIP"),
        FormatMeta("tfrecord", "TFRecord", "zip", "tf.Example TFRecord ZIP"),
    ],
}
...
_EXPORTERS: Dict[str, Dict[str, ExporterFn]] = {
    ...
    "embodied": {
        ...
        "tfrecord": embodied.export_embodied_tfrecord,
